...
- [ ] Add completeness test for `.md` doc files (deferred — not all codes have docs yet; ErrorDocs already validates existing ones)
...
- [ ] Completeness test validates each code has a `.md` doc file (deferred — not all codes documented yet)
