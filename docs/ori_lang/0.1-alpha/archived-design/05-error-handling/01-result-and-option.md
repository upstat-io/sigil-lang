...
This document covers Ori's core error handling types: `Result<T, E>` and `Option<T>`. These types replace exceptions with explicit, type-safe error handling.

---

## Philosophy

Ori rejects exceptions in favor of explicit error types:
