...
This section covers Ori's approach to errors: Result types, the try pattern, custom error types, and panics.
...
Ori uses explicit error types instead of exceptions:
