...
This section covers Ori's syntax for functions, configuration, expressions, and the pattern system.
...
| [Patterns Overview](03-patterns-overview.md) | Introduction to Ori's pattern system |
