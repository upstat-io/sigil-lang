...
This section describes Ori's design philosophy and the principles that guide language decisions.
...
|----------|-------------|
| [AI-First Design](01-ai-first-design.md) | Why Ori optimizes for AI-authored code |
...
Ori's core thesis: **AI will be the primary author of code in the future.** Ori is designed for AI as a first-class citizen, while remaining human-readable and writable.
