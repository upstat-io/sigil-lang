...
Ori's error output is designed for AI self-correction. Every error includes structured data, semantic addresses, and ready-to-apply fix suggestions.
  ...
  "errors": [
    {
      ...
      "context": {
        ...
        "surrounding_code": "    result = value + \"hello\""
      },
      "suggestions": [
        {
      ...
      "related": [
        {
          "file": "src/main.ori",
          "line": 10,
          "message": "value defined here as int"
        }
      ],
      "docs_url": "https://ori-lang.org/errors/E0308",
      "is_primary": true
    }
  ],
  "warnings": [],
...
error[E0308]: mismatched types
  --> src/main.ori:15:10
   |
15 |     result = value + "hello"
   |              ^^^^^^^^^^^^^^^ expected int, found str
   |
   = help: convert int to str with str(value)
   = see: https://ori-lang.org/errors/E0308
...
# 4. AI applies edits
ori edit apply-json < edits.json
...
Example (incorrect):
    @add (left: int, right: str) -> int = left + right
                                          ^^^^^^^^^^^^ str is not int
