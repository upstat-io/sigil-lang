...
This document covers Ori's `match` pattern for pattern matching: basic syntax, structure, and using match as an expression.
...
Match works seamlessly with other Ori patterns:
