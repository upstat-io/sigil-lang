...
This document covers Ori's flow-sensitive typing: how the compiler tracks more specific types after type checks, narrowing functions, scope rules, and how assertions affect types.
...
Ori requires explicit type checks. Values don't implicitly convert to boolean.
