...
This document covers how to define functions in Ori, including syntax, parameters, return types, visibility, and generics.

---

## Basic Syntax

Functions in Ori are defined with the `@` prefix:
...
Ori uses the `@` prefix to make function definitions visually distinct:
