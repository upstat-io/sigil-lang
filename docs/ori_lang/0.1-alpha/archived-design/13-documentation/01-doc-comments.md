...
This document covers Ori's documentation comment syntax.
...
@parse_duration (input: str) -> Result<int, ParseError> = ...
```
...
Examples should be valid Ori expressions that could be run in a REPL.
...
- `@` — ties into Ori's ori convention
