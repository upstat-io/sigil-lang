...
### Why This Works in Ori

1. **Structural sharing** — Ori's immutable data structures share unchanged parts. "Hello World" and "Hello" share the "Hello" bytes.
...
5. **Structural sharing** — Ori's immutable collections share unchanged parts, making storage efficient despite keeping full states.
