...
Sigil's ARC memory model forbids bidirectional references to prevent cycles. This makes certain common patterns awkward:
...
**No language changes required** — this is purely a standard library addition using existing Sigil features.
