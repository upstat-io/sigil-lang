...
This section covers Sigil's tooling for AI-first development: semantic addressing, structured errors, formatter, LSP, REPL, and refactoring API.
...
Sigil's tooling is designed for AI integration:
