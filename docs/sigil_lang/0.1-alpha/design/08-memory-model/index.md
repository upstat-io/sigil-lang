...
This section covers Sigil's memory management: automatic reference counting, value semantics, and efficient data structures.
...
Sigil uses Automatic Reference Counting (ARC) for memory management:
