...
//   Trace:
//     parse_user     at src/users.si:25:12
//     fetch_user     at src/users.si:18:16
//     load_dashboard at src/dashboard.si:45:20
//     main           at src/main.si:10:5
```
...
### Current Sigil Error Model

Sigil's `Error` type supports manual chaining:
...
Trace:
  read_file at std/fs.si:142:8
  load      at src/loader.si:15:20
  main      at src/main.si:8:16
```
...
Trace:
  parse       at std/json.si:89:12
  load_config at src/config.si:18:16
  main        at src/main.si:5:20
```
...
// Trace:
//   validate           at src/validation.si:42:8
//   fetch_and_process  at src/api.si:19:20
//   handle_request     at src/server.si:88:12
```
...
// Error: deep error
// Trace:
//   d at src/example.si:4:35
//   c at src/example.si:3:35
//   b at src/example.si:2:35
//   a at src/example.si:1:35
```
...
Unlike Zig, Sigil should collect traces in all builds:
- Consistent behavior (Sigil principle)
...
- Against Sigil's "explicit error handling" philosophy
...
This aligns with Sigil's philosophy of being explicit about errors while reducing debugging friction for both humans and AI.
