...
**Rule: Patterns always use vertical/stacked format with named properties.**

This is the canonical format for all patterns:
...
**Exception:** `run` and `try` patterns use binding syntax, not named properties:
