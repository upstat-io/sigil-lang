...
```sigil
status1 = Pending
status2 = Running(progress: 0.5)
status3 = Failed(error: "connection lost")
...
```sigil
pair_of_ints = Pair { first: 1, second: 2 }
pair_of_strings = Pair { first: "a", second: "b" }
