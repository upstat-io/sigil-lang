/* @ts-self-types="./ori_playground_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function format_ori(source, max_width) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.format_ori(ptr0, len0, isLikeNone(max_width) ? 0x100000001 : (max_width) >>> 0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
 ...
 * @returns {string}
 */
export function run_ori(source) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.run_ori(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
function __wbg_get_imports() {
    const import0 = {
        __proto__: null,
        __wbg_log_1d90176b96b96526: function(arg0, arg1) {
    ...
    return {
        __proto__: null,
        "./ori_playground_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('ori_playground_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
