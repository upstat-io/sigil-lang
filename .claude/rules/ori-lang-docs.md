...
When editing files in `docs/ori_lang/`, follow these guidelines.
...
- [ ] Ask user: "Should I create a draft proposal in `docs/ori_lang/proposals/drafts/` for this change to be applied to the compiler?"
