...
pub use items::{
    ...
    ExtensionImportItem, FileAttr, Function, GenericParam, ImplAssocType, ImplDef, ImplMethod,
    ImportErrorKind, ImportPath, Module, Param, StructField, TargetAttr, TestDef, TraitAssocType,
