        ...
        while !self.is_at_end() {
            ...
            if self.check(TokenKind::At) {
                ...
                errors.push(ParseError {
                    code: sigil_diagnostic::ErrorCode::E1006,
...
pub struct ParseError {
    ...
    pub code: sigil_diagnostic::ErrorCode,
...
impl ParseError {
    ...
    pub fn new(code: sigil_diagnostic::ErrorCode, message: impl Into<String>, span: Span) -> Self {
        ParseError {
            code,
    ...
    pub fn to_diagnostic(&self) -> sigil_diagnostic::Diagnostic {
        sigil_diagnostic::Diagnostic::error(self.code)
...
mod tests {
    use super::*;
    use sigil_ir::{BinaryOp, BindingPattern, ExprKind, FunctionExpKind, FunctionSeq};
    use sigil_lexer;
