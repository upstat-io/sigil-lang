...
impl<'ctx> LLVMCodegen<'ctx> {
    ...
    /// Map a Sigil TypeId to an LLVM type.
    ...
    /// Map a Sigil TypeId to an LLVM metadata type (for function params).
    ...
    fn compile_struct(
        &self,
        _name: Name,
        fields: sigil_ir::ast::FieldInitRange,
        arena: &ExprArena,
        expr_types: &[TypeId],
        locals: &mut HashMap<Name, BasicValueEnum<'ctx>>,
        function: FunctionValue<'ctx>,
    ...
    fn compile_str_concat(
        ...
        let str_concat = self.module.get_function("sigil_str_concat")?;
        ...
        // Call sigil_str_concat(ptr, ptr) -> SigilStr
    ...
    fn compile_str_eq(
        ...
        let str_eq = self.module.get_function("sigil_str_eq")?;
        ...
        // Call sigil_str_eq(ptr, ptr) -> bool
        let result = self.builder.build_call(
            str_eq,
            &[lhs_ptr.into(), rhs_ptr.into()],
            "str_eq_result"
    ...
    fn compile_str_ne(
        ...
        let str_ne = self.module.get_function("sigil_str_ne")?;
        ...
        // Call sigil_str_ne(ptr, ptr) -> bool
        let result = self.builder.build_call(
            str_ne,
            &[lhs_ptr.into(), rhs_ptr.into()],
            "str_ne_result"
    ...
    fn compile_map(
        &self,
        entries: sigil_ir::ast::MapEntryRange,
        arena: &ExprArena,
        expr_types: &[TypeId],
        locals: &mut HashMap<Name, BasicValueEnum<'ctx>>,
        function: FunctionValue<'ctx>,
    ...
    fn compile_lambda(
        &self,
        params: sigil_ir::ast::ParamRange,
        body: ExprId,
        arena: &ExprArena,
        expr_types: &[TypeId],
        locals: &HashMap<Name, BasicValueEnum<'ctx>>,
    ...
    fn compile_function_exp(
        ...
        use sigil_ir::ast::patterns::FunctionExpKind;
...
mod tests {
    ...
    fn test_match_literal() {
        use sigil_ir::ast::patterns::MatchArm;
    ...
    fn test_duration_literal() {
        ...
        let duration_expr = arena.alloc_expr(Expr {
            kind: ExprKind::Duration {
                value: 5,
                unit: sigil_ir::DurationUnit::Seconds,
            },
            span: sigil_ir::Span::new(0, 1),
        });
    ...
    fn test_size_literal() {
        ...
        let size_expr = arena.alloc_expr(Expr {
            kind: ExprKind::Size {
                value: 2,
                unit: sigil_ir::SizeUnit::Kilobytes,
            },
            span: sigil_ir::Span::new(0, 1),
        });
