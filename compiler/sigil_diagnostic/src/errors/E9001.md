...
This error indicates a bug in the Sigil compiler itself, not in your code.
...
1. **Report the bug:**
   - Go to https://github.com/sigil-lang/sigil/issues
   - Include the full error message
   - Include a minimal code example that reproduces the issue
   - Include your Sigil version (`sigil --version`)
...
```markdown
**Sigil version:** (output of `sigil --version`)
