...
pub trait TExprTraversal: Sized {
    ...
    fn on_match(
        ...
        if Self::AUTO_RECURSE {
            ...
            let arm_results: Result<Vec<_>, _> =
                m.arms.iter().map(|arm| self.traverse(&arm.body)).collect();
