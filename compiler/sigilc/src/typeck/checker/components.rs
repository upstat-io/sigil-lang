...
use crate::diagnostic::queue::DiagnosticQueue;
use crate::ir::{ExprArena, Name, StringInterner};
use crate::types::{InferenceContext, Type, TypeEnv};
use sigil_patterns::PatternRegistry;

use super::super::operators::TypeOperatorRegistry;
use super::super::type_registry::{TraitRegistry, TypeRegistry};
