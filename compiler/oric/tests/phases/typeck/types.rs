//! Tests for the Ori type system (`ori_types`).
//!
//! These tests verify:
//! - Type primitives and display
//! - Type environment scoping
//! - Unification algorithm
//! - Occurs check (infinite type detection)
//! - Type scheme generalization and instantiation
//! - Type context deduplication
//! - Error diagnostics

#![expect(clippy::unwrap_used, reason = "Tests use unwrap for brevity")]

use ori_ir::{SharedInterner, Span};
use ori_types::{InferenceContext, Type, TypeContext, TypeEnv, TypeError, TypeScheme, TypeVar};
