...
//! all compiler phases. Debug flags can be set via the `ORI_DEBUG`
//! environment variable.
//!
//! # Environment Variable
//!
//! Set `ORI_DEBUG` to a comma-separated list of flags:
...
//!
//! Example: `ORI_DEBUG=tokens,types cargo run`
