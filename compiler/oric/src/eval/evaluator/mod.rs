//! Expression evaluator for the Ori interpreter.
//!
...
/// Tree-walking evaluator for Ori expressions.
...
impl<'a> Evaluator<'a> {
    ...
    pub fn register_prelude(&mut self) {
        use ori_eval::{function_val_str, function_val_int, function_val_float, function_val_byte, function_val_thread_id};
